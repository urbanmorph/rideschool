...
@logins_bp.route('/update_participant_status', methods=['POST'])
...
def update_participant_status():
    try:
        ...
        db_cursor.execute("UPDATE participants SET participant_status = %s WHERE participant_id = %s", (newStatus, participantId))
        get_db_connection().commit()
        db_cursor.close()

 # Debugging: Print the received data
        print("Received data: participantId =", participantId, "newStatus =", newStatus)
